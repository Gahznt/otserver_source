...
bool ProtocolLogin::parseFirstPacket(NetworkMessage& msg)
{
	...
	{
		getConnection()->close();
		//disconnectClient(0x0A, (char*)g_config.getString(ConfigManager::OPC_ALLOWED_VERSION_FAIL_STRING).c_str());
		return false;
	}
    ...
    // <onepiece>
    // OperatingSystem_t configOS = (OperatingSystem_t) g_config.getNumber(ConfigManager::OPC_ALLOWED_VERSION);
    // if(configOS && operatingSystem != configOS)
    // {
        // disconnectClient(0x0A, (char*)g_config.getString(ConfigManager::OPC_ALLOWED_VERSION_FAIL_STRING).c_str());
        // return false;
    // }
