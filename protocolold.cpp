...
/*
   E S S E      A R Q U I V O        N A O       E H      U S A D O      N O      S E R V E R
*/

bool ProtocolOld::parseFirstPacket(NetworkMessage& msg) {
     
    std::cout << "[EXECUTOU] protocolold.cpp :: bool ProtocolOld::parseFirstPacket(NetworkMessage& msg) '" << std::endl;
