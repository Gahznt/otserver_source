...
ACLOCAL = ${SHELL} /root/Dropbox/Dedicado/13/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /root/Dropbox/Dedicado/13/missing --run autoconf
AUTOHEADER = ${SHELL} /root/Dropbox/Dedicado/13/missing --run autoheader
AUTOMAKE = ${SHELL} /root/Dropbox/Dedicado/13/missing --run automake-1.11
AWK = mawk
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lmysqlclient -lboost_filesystem-mt -lboost_date_time-mt -lboost_system-mt -lboost_regex-mt -lboost_thread-mt -lgmp  -L/usr/lib/x86_64-linux-gnu -lxml2
LTLIBOBJS = 
LUA_CFLAGS = -I/usr/include/lua5.1  
LUA_LIBS = -llua5.1  
MAKEINFO = ${SHELL} /root/Dropbox/Dedicado/13/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /root/Dropbox/Dedicado/13
abs_srcdir = /root/Dropbox/Dedicado/13
abs_top_builddir = /root/Dropbox/Dedicado/13
abs_top_srcdir = /root/Dropbox/Dedicado/13
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /root/Dropbox/Dedicado/13/install-sh
