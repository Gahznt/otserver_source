...
class ChatChannel
{
	public:
		...
		int32_t getMuteConditionId() const {return m_muteConditionId;}
		const std::string& getMuteConditionMessage() const {return m_muteConditionMessage;}		
	protected:
		void configureChannelMuteConditions();
		...
		std::string m_muteConditionMessage;
		int32_t m_muteConditionId;
		int32_t m_accessToMute;
		Condition* m_muteCondition;
