...
class LuaScriptInterface
{
	...
	protected:
        ...
        // <onepiece>
            static int32_t luaInternalCreatureChangeVisible(lua_State* L);
            static int32_t luaSetMonsterName(lua_State* L);
            static int32_t luaDoPlayerAddSkillLevel(lua_State* L);
            static int32_t luaDoPlayerSetTarget(lua_State* L);
            static int32_t luaDoCreateMonsterForced(lua_State* L);
            
            // Navegacao
            static int32_t luaGetPlayerIsNavigating(lua_State* L);
            static int32_t luaSetPlayerIsNavigating(lua_State* L);
            
            static int32_t luaDoSendPlayerExtendedOpcode(lua_State* L);
            static int32_t luaSetPlayerCriticalExtraChance(lua_State* L);
            
            static int32_t luaSetPlayerExtraFoodRegen(lua_State* L);
            static int32_t luaSetPlayerExtraFoodDmg(lua_State* L);
            static int32_t luaSetPlayerExtraFoodDef(lua_State* L);                        
            
            static int32_t luaGetContainerItemEx(lua_State* L);
            static int32_t luaGetCreatureDefaultOutfit(lua_State* L);
            
            static int32_t luaGetPlayerCharmExtraDamageChance(lua_State* L);
