...
class ConfigManager
{
	public:
		...
		enum string_config_t
		{
			...
			//OPC_ALLOWED_VERSION_FAIL_STRING,			
		...
		enum number_config_t
		{
			...
			HOUSE_CLEAN_OLD,
			//OPC_ALLOWED_VERSION,
			OPC_CHOPPER_OUTFIT_WALK_POINT,
			OPC_CHOPPER_OUTFIT_HEAVY_POINT,
			OPC_CHOPPER_OUTFIT_GUARD_POINT,            			
			OPC_CHOPPER_OUTFIT_GUARD_POINT_ROLLOUT,            			
    		OPC_CHOPPER_OUTFIT_JUMP_POINT,
    		OPC_CHOPPER_OUTFIT_HORN_POINT,    		
    		OPC_CHOPPER_OUTFIT_ARM_POINT,    		
    		OPC_LUFFY_OUTFIT_FUUSEN,
    		OPC_LUFFY_OUTFIT_FUUSEN_PINK,
			OPC_LUFFY_OUTFIT_FUUSEN_2,
    		OPC_LUFFY_OUTFIT_FUUSEN_PINK_2,
			
			MOVE_THING_DELAY,
			POTION_EXAUSTION_GROUND_SPEED,
			
			WOP_CRITICAL_USOPP_BONUS,
            WOP_CRITICAL_CHOPPER_BRAIN_POINT_BONUS,
		...
		enum double_config_t
		{
			...
			FORMULA_LEVEL,
			FORMULA_MAGIC,
			OPC_CHOPPER_DAMAGE_WALK_POINT,
			OPC_CHOPPER_DAMAGE_HEAVY_POINT,
			OPC_CHOPPER_DAMAGE_GUARD_POINT,            			
			OPC_CHOPPER_DAMAGE_GUARD_POINT_ROLLOUT,            			
    		OPC_CHOPPER_DAMAGE_JUMP_POINT,
    		OPC_CHOPPER_DAMAGE_HORN_POINT,    		
    		OPC_CHOPPER_DAMAGE_ARM_POINT,    		
            OPC_CHOPPER_DEF_WALK_POINT,
			OPC_CHOPPER_DEF_HEAVY_POINT,
			OPC_CHOPPER_DEF_GUARD_POINT,            			
			OPC_CHOPPER_DEF_GUARD_POINT_ROLLOUT,            			
    		OPC_CHOPPER_DEF_JUMP_POINT,
    		OPC_CHOPPER_DEF_HORN_POINT,    		
    		OPC_CHOPPER_DEF_ARM_POINT, 
            OPC_LUFFY_DEF_OUTFIT_FUUSEN,   		    		
            OPC_LUFFY_DEF_OUTFIT_FUUSEN_PINK,
			OPC_LUFFY_DEF_OUTFIT_FUUSEN_2,
            OPC_LUFFY_DEF_OUTFIT_FUUSEN_PINK_2,
            OPC_RED_SKULL_EXP_PERCENT_LOSS,
            OPC_RED_SKULL_PLAYER_DAMAGE,
            WOP_LUFFY_BLOCK_PHYSICAL,
