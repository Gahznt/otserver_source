...
struct DeathEntry
{
        ...
        // <onepiece> -- corpse loot protect fix
...
class Creature : public AutoId, virtual public Thing
{
	...
	public:
		...
		int32_t getStepDuration(Direction dir, bool fixed = false) const;
		int32_t getStepDuration(bool fixed = false) const;
		...
		// <onepiece>
		const void setDefaultOutfit(Outfit_t outfit) {defaultOutfit = outfit;}
		// </onepiece>
