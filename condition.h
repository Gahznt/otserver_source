...
enum ConditionType_t {
	...
	CONDITION_FAST_ATTACK  = 1 << 24   // WOP 
};
...
class Condition
{
	public:
        ...
        // <onepiece>
		virtual bool setParam(ConditionParam_t param, float value);
        // </onepiece>
...
// <onepiece>
class ConditionFastAttack : public ConditionGeneric
{
	public:
		ConditionFastAttack(ConditionId_t _id, ConditionType_t _type, int32_t _ticks, bool _buff, uint32_t _subId);
		virtual ~ConditionFastAttack() {}
		...
		virtual ConditionFastAttack* clone() const {return new ConditionFastAttack(*this);}
	...
	protected:
        // `fastAttack` é o numero em ms em que vai ser subtraido, ou seja, se estiver 1000 vai demorar 1s a menos cada ataque :)
		uint32_t fastAttack;
};
// </onepiece>
