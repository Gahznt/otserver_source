...
bool ConfigManager::load()
{
    ...
    // <onepiece>
    //m_confNumber[OPC_ALLOWED_VERSION]             = getGlobalNumber("OPC_ALLOWED_VERSION", 10);
    //m_confString[OPC_ALLOWED_VERSION_FAIL_STRING] = getGlobalString("OPC_ALLOWED_VERSION_FAIL_STRING", "Outdated client...");
    
    m_confBool[PLAYER_BLOCKS_RESPAWN] = getGlobalBool("PLAYER_BLOCKS_RESPAWN", true);
    
    m_confNumber[OPC_LUFFY_OUTFIT_FUUSEN]           = getGlobalNumber("OPC_LUFFY_OUTFIT_FUUSEN", 0);
    m_confNumber[OPC_LUFFY_OUTFIT_FUUSEN_PINK]      = getGlobalNumber("OPC_LUFFY_OUTFIT_FUUSEN_PINK", 0);
    m_confDouble[OPC_LUFFY_DEF_OUTFIT_FUUSEN]       = getGlobalDouble("OPC_LUFFY_DEF_OUTFIT_FUUSEN",      1);
    m_confDouble[OPC_LUFFY_DEF_OUTFIT_FUUSEN_PINK]  = getGlobalDouble("OPC_LUFFY_DEF_OUTFIT_FUUSEN_PINK", 1);
    
    m_confNumber[OPC_LUFFY_OUTFIT_FUUSEN_2]           = getGlobalNumber("OPC_LUFFY_OUTFIT_FUUSEN_2", 0);
    m_confNumber[OPC_LUFFY_OUTFIT_FUUSEN_PINK_2]      = getGlobalNumber("OPC_LUFFY_OUTFIT_FUUSEN_PINK_2", 0);
    m_confDouble[OPC_LUFFY_DEF_OUTFIT_FUUSEN_2]       = getGlobalDouble("OPC_LUFFY_DEF_OUTFIT_FUUSEN_2",      1);
    m_confDouble[OPC_LUFFY_DEF_OUTFIT_FUUSEN_PINK_2]  = getGlobalDouble("OPC_LUFFY_DEF_OUTFIT_FUUSEN_PINK_2", 1);
    
    m_confNumber[OPC_CHOPPER_OUTFIT_WALK_POINT]  = getGlobalNumber("OPC_CHOPPER_OUTFIT_WALK_POINT", 1);
    m_confNumber[OPC_CHOPPER_OUTFIT_HEAVY_POINT] = getGlobalNumber("OPC_CHOPPER_OUTFIT_HEAVY_POINT", 1);
    m_confNumber[OPC_CHOPPER_OUTFIT_GUARD_POINT] = getGlobalNumber("OPC_CHOPPER_OUTFIT_GUARD_POINT", 1);
    m_confNumber[OPC_CHOPPER_OUTFIT_GUARD_POINT_ROLLOUT] = getGlobalNumber("OPC_CHOPPER_OUTFIT_GUARD_POINT_ROLLOUT", 1);
    m_confNumber[OPC_CHOPPER_OUTFIT_JUMP_POINT]  = getGlobalNumber("OPC_CHOPPER_OUTFIT_JUMP_POINT", 1);
    m_confNumber[OPC_CHOPPER_OUTFIT_HORN_POINT]  = getGlobalNumber("OPC_CHOPPER_OUTFIT_HORN_POINT", 1);
    m_confNumber[OPC_CHOPPER_OUTFIT_ARM_POINT]   = getGlobalNumber("OPC_CHOPPER_OUTFIT_ARM_POINT", 1);

    m_confDouble[OPC_CHOPPER_DAMAGE_WALK_POINT]  = getGlobalDouble("OPC_CHOPPER_DAMAGE_WALK_POINT", 1);
    m_confDouble[OPC_CHOPPER_DAMAGE_HEAVY_POINT] = getGlobalDouble("OPC_CHOPPER_DAMAGE_HEAVY_POINT", 1);
    m_confDouble[OPC_CHOPPER_DAMAGE_GUARD_POINT] = getGlobalDouble("OPC_CHOPPER_DAMAGE_GUARD_POINT", 1);
    m_confDouble[OPC_CHOPPER_DAMAGE_GUARD_POINT_ROLLOUT] = getGlobalDouble("OPC_CHOPPER_DAMAGE_GUARD_POINT_ROLLOUT", 1);
    m_confDouble[OPC_CHOPPER_DAMAGE_JUMP_POINT]  = getGlobalDouble("OPC_CHOPPER_DAMAGE_JUMP_POINT", 1);
    m_confDouble[OPC_CHOPPER_DAMAGE_HORN_POINT]  = getGlobalDouble("OPC_CHOPPER_DAMAGE_HORN_POINT", 1);
    m_confDouble[OPC_CHOPPER_DAMAGE_ARM_POINT]   = getGlobalDouble("OPC_CHOPPER_DAMAGE_ARM_POINT", 1);
    
    m_confDouble[OPC_CHOPPER_DEF_WALK_POINT]  = getGlobalDouble("OPC_CHOPPER_DEF_WALK_POINT", 1);
    m_confDouble[OPC_CHOPPER_DEF_HEAVY_POINT] = getGlobalDouble("OPC_CHOPPER_DEF_HEAVY_POINT", 1);
    m_confDouble[OPC_CHOPPER_DEF_GUARD_POINT] = getGlobalDouble("OPC_CHOPPER_DEF_GUARD_POINT", 1);
    m_confDouble[OPC_CHOPPER_DEF_GUARD_POINT_ROLLOUT] = getGlobalDouble("OPC_CHOPPER_DEF_GUARD_POINT_ROLLOUT", 1);
    m_confDouble[OPC_CHOPPER_DEF_JUMP_POINT]  = getGlobalDouble("OPC_CHOPPER_DEF_JUMP_POINT", 1);
    m_confDouble[OPC_CHOPPER_DEF_HORN_POINT]  = getGlobalDouble("OPC_CHOPPER_DEF_HORN_POINT", 1);
    m_confDouble[OPC_CHOPPER_DEF_ARM_POINT]   = getGlobalDouble("OPC_CHOPPER_DEF_ARM_POINT", 1);

	m_confBool[POTION_EXAUSTION] = getGlobalBool("potionExaustionEnabled", true);
	m_confNumber[POTION_EXAUSTION_GROUND_SPEED] = getGlobalNumber("potionExaustionGroundSpeed", 150);
	m_confNumber[MOVE_THING_DELAY] = getGlobalNumber("moveThingDelay", 1);
	
	m_confDouble[OPC_RED_SKULL_EXP_PERCENT_LOSS]         = getGlobalDouble("OPC_RED_SKULL_EXP_PERCENT_LOSS", 1.0);
	m_confDouble[OPC_RED_SKULL_PLAYER_DAMAGE]            = getGlobalDouble("OPC_RED_SKULL_PLAYER_DAMAGE", 1.0);
	m_confDouble[WOP_LUFFY_BLOCK_PHYSICAL]               = getGlobalDouble("WOP_LUFFY_BLOCK_PHYSICAL", 0.0);
	m_confNumber[WOP_CRITICAL_USOPP_BONUS]               = getGlobalNumber("WOP_CRITICAL_USOPP_BONUS", 0);
	m_confNumber[WOP_CRITICAL_CHOPPER_BRAIN_POINT_BONUS] = getGlobalNumber("WOP_CRITICAL_CHOPPER_BRAIN_POINT_BONUS", 0);
