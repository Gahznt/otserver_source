...
bool Vocations::parseVocationNode(xmlNodePtr p)
{
    ...
    // <onepiece>
	if(readXMLFloat(p, "gainhpticks", floatValue) || readXMLFloat(p, "gainhealthticks", floatValue))
		voc->setGainTicks(GAIN_HEALTH, floatValue);
    // </onepiece>
    ...
    // <onepiece>
	if(readXMLFloat(p, "gainmanaticks", floatValue))
		voc->setGainTicks(GAIN_MANA, floatValue);
    // </onepiece>
    ...
    // <onepiece>
	if(readXMLFloat(p, "gainsoulticks", floatValue))
		voc->setGainTicks(GAIN_SOUL, floatValue);
    // </onepiece>
